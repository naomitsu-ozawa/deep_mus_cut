...
# OK
def run_batch_predictions(sub_dir, pint, progress_dict, worker_id, x):
    console = Console()
    spinner = Spinner(
...
# メイン関数
def main(folder_path, num_workers, pint):
...
if __name__ == "__main__":
    ...
    def wrapped_main():
        main(folder_path, num_workers, pint)
